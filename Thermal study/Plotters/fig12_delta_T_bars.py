...
======================
Through-thickness temperature gradient ΔT [K] at peak heating,
shown as a bar chart grouped by material and orientation.
High χ = full colour, Low χ = muted.  Replicate dots overlaid.

ΔT = T_hot − T_cold = front-face minus back-face temperature.
Values come from prof_df (T_hot_C − T_cold_C) or dT_K if that column exists.
...
# ── Configuration ──────────────────────────────────────────────────────────────
FIGURE_BASENAME = "fig12_delta_T_bars"
FIG_WIDTH_MM    = 178
FIG_HEIGHT_MM   = 65
...
dv      = "delta_T"
y_label = r"$\Delta T = T_{\rm hot} - T_{\rm cool}$ [K]"
